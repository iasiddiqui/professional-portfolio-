...
const envSchema = z.object({
  ...
  GITHUB_CACHE_TTL_MS: z.coerce.number().int().positive().default(900_000),
  ...
  GITHUB_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(900_000),
  GITHUB_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(30),
