...
export const DEFAULT_CONTACT_CONFIRMATION: LeadConfirmationTemplateCopy = {
...
export const DEFAULT_HIRE_ME_CONFIRMATION: LeadConfirmationTemplateCopy = {
...
export const DEFAULT_CONSULTATION_CONFIRMATION: LeadConfirmationTemplateCopy = {
...
export const DEFAULT_ADMIN_NOTIFICATION: AdminNotificationTemplateCopy = {
...
export const DEFAULT_SITE_EMAIL_TEMPLATES: SiteEmailTemplates = {
  contact: DEFAULT_CONTACT_CONFIRMATION,
  hireMe: DEFAULT_HIRE_ME_CONFIRMATION,
  consultation: DEFAULT_CONSULTATION_CONFIRMATION,
  admin: DEFAULT_ADMIN_NOTIFICATION,
};
